...
def gcloud_download():
    download(
        name="gcloud",
        darwin_arm_urls=[
            "https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-cli-443.0.0-darwin-arm.tar.gz"
        ],
        darwin_arm_sha="791a18beddd6620ffd52a4d6a1e14ad5f02a9126e05e78b7250d6b55f4116beb",
        linux_x86_urls=[
            "https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-cli-443.0.0-linux-x86_64.tar.gz"
        ],
        linux_x86_sha="332627b07483ed0e91155c4a9189e15bbdf1ae20265d6784f94672f566831387",
    )
...
def gcloud_auth(name):
    gcloud_auth_activate_refresh_token(name, "$CLOUDSDK_AUTH_ACCOUNT", "$CLOUDSDK_AUTH_REFRESH_TOKEN")
